CKI package v0.5.0 with submission packages: v47 (Genome Biology first-author revision) -> v48 (Nature Communications format conversion) -> v49.9 (NC enhanced submission, latest).
