...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p("Cross-species matching note (Supplementary Fig. S12): the mouse-human cell-type matching used for the cross-species comparison is case-insensitive exact matching over a small explicit alias table (notebooks/_ed_fig2_clean.py), because cell-type names in results/full_matrix_pairs.csv are truncated to 18 characters. This rule matches 15 shared cell types between the Tabula Muris and Tabula Sapiens annotations; case-sensitive exact-string matching alone would match 11. Re-running the comparison with a different matching rule will change the plotted cell-type set."),
      ...
      p(""),
      p("  l. Cross-species analysis (M-B1): Added mention in Discussion that preliminary cross-species validation was performed (Supplementary Fig. S12)."),
      p(""),
      ...
      p("     Script: notebooks/79_kang_ifnb_demo.py (analysis), notebooks/80_kang_demo_figure.py (Fig. S10)"),
