...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p(""),
      p("  j. Parameter justification (M-M5): Added as Limitation #15 and Section 3.11 of the Supplementary Information (Parameter Justification) (normalization pseudo-count, epsilon, top-200 DE, HVG count, log-base 2, B=1000)."),
      p(""),
      ...
      p("     Script: notebooks/79_kang_ifnb_demo.py (analysis), notebooks/80_kang_demo_figure.py (Supplementary Fig. 10)"),
