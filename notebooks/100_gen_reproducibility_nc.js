...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      heading("4.3 Real-Data Drift Calibration (Kang IFN-\u03b2 PBMC + Siletti Brain Ladder) \u2014 Result 4 (Fig. 4)", 3),
      ...
      p("  Output: results/nc49_brain_drift_ladder.csv. Figures: notebooks/nc49_fig_drift_ladder.py (Fig. 4; results/figures_final/nc49_fig_drift_ladder.pdf/.png)."),
      p(""),

      heading("4.4 TCGA (Human Cancer) \u2014 Result 5 (Fig. 5)", 3),
      ...
      p("     Scripts: notebooks/nc49_fig_drift_ladder.py (Fig. 4), notebooks/nc49_fig_tcga.py (Fig. 5)"),
