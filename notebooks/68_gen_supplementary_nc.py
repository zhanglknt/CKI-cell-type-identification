...
add_para(
    'Note: in the released cki package (v0.5.1), bootstrap_test() reproduces lines 9-15 '
...
add_para(
    ...
    'cki package (v0.5.1), the tested tail is selected by the tail parameter of '
