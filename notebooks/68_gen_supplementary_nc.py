...
add_para(
    'Note: in the released cki package (v0.5.3), bootstrap_test() reproduces lines 9-15 '
...
add_para(
    ...
    'cki package (v0.5.3), the tested tail is selected by the tail parameter of '
...
add_para(
    ...
    'full expression-matrix cohort (LIHC 366 and KIRC 754 tumors, 750 KIRC retained at pair level; seed 42, 60 markers per '
