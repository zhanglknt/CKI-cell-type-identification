...
add_para(
    ...
    'the direction of the neutrality index and inherits its caveats. '
...
add_para(
    ...
    'ordering and significance pattern is preserved (notebooks/'
...
add_para(
    ...
    'median \u22121.2%, 95% CI [\u22125.0%, +2.3%]); per-cancer attenuation '
    'LIHC +31.7% [+21.0%, +45.3%], KIRC +19.4% [+14.7%, +23.9%], BRCA '
    '\u221215.9% [\u221223.9%, \u22127.9%], LUAD \u22122.3%, LUSC '
    '\u22129.5%; the within-TT correlation of k_n with the composition '
    'difference is Spearman \u03c1 = 0.364 pooled (n = 10,000 pairs, '
    'P < 10\u207b\u00b3\u2070\u2070; per-cancer 0.196\u20130.513, each '
    'n = 2,000, all P \u2264 7.7 \u00d7 10\u207b\u00b9\u2079). Composition '
...
add_para(
    ...
    'committed oligodendrocyte precursors (0.043). Script: '
