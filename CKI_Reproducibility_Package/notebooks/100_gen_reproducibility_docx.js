...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p("Version: 0.4.2 (editable install from project root)"),
      ...
      p("[\u2713] Install CKI v0.4.2: pip install -e ."),
